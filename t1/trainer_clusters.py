...
def myModel():
    ...
    classes = [176,39,166,70,67,98,332,240,137,129,89,422,207,97,192,198,83,109,318,108,213,43,147,29,168,165,85,89,94,115]

    input = Input(shape=(5,362))
...
training=GeneratorFromChunks(ds[0:15000])
test=GeneratorFromChunks(ds[15000:16000])
...
def train(mp):
    ...
    model1.fit_generator(training,steps_per_epoch=15000,epochs=100,max_q_size=3,validation_data=test,validation_steps=1000,callbacks=[saver,stopper])
